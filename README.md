...
The native user driver is silent: Sparkle never presents its permission, found-update, progress, or install dialogs. Download progress and ready-to-install land on `setEventHandler`; `installUpdateNow()` is what relaunches.
